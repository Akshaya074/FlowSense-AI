    ...
    try {
      ...
      const chat = model.startChat({
        history: [
          ...
          { role: "model", parts: [{ text: "Understood. I will answer based strictly on the provided context logs." }] }
        ]
      });
      ...
      console.warn(`[FlowSense AI] Model "${modelName}" failed: ${err.message}`);
